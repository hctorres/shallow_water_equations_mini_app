...
int main (int argc, char* argv[])
{
    ...
    //amrex::Box face_centered_box(dom_lo, dom_hi+1, amrex::IndexType({1,1}));
    amrex::Box face_centered_box = amrex::surroundingNodes(cell_centered_box);

    amrex::Print() << "Cell centered box " << cell_centered_box << std::endl;
    amrex::Print() << "Face centered box " << face_centered_box << std::endl;
...
//                     { 1., 1.});
...

   {
    ...
    // Maybe move the domain and real box here
